...
def readFile(DataFileIn,DataFileOut):
 # These are the locations (column index) of Mass #, Proton #, S2n, S2n Error, S2p, S2p Error,
 # Q_alpha, Q_alpha Error
 aa = 0
 az = 2
 as2n = 3
 as2nErr = 4
...
#  "Qa_Error(MeV)".ljust(CC+5)
 ...
 f1.close()
 output.close()
DataFileIn='AME_NoHeader/rct1.mas03NH.txt'
DataFileOut='2003AME_S2.dat'
readFile(DataFileIn,DataFileOut)    #arg: (DataFileIn,DataFileOut)

DataFileIn='AME_NoHeader/rct1-16NH.txt'
DataFileOut='2016AME_S2.dat'
readFile(DataFileIn,DataFileOut)    #arg: (DataFileIn,DataFileOut)
